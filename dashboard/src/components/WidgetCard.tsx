export default function WidgetCard({ isEmpty = false }) {
    ...
    if (isEmpty) {
        return (
            <div className="flex flex-row justify-center items-center bg-[#181818] p-[16px] rounded-md w-[320px] h-[180px]">
                <button 
    ...
    return (
        <div className="bg-[#181818] p-[16px] rounded-md w-[320px] h-[180px] group">
